...
module.exports = {
  name: 'forward',
  description: 'This command forwards the music by a specified time.',
  ...
  if (!serverQueue)
    ...
    .setDescription(`Number too small.`));
        ...
        serverQueue.connection.dispatcher.end("Forwarding song");
    else{
      message.channel.send(new Discord.MessageEmbed()
      .setColor(client.config.embedColors.music)
        .setDescription(`You cannot forward when I am already forwarding!`))
      ...
      return;
        ...
        return message.channel.send(new Discord.MessageEmbed()
        .setColor(client.config.embedColors.music)
            .setDescription(` Forwarded [${current.title}](${current.url}) to **${minute}:${seconde}**.`));
  }
  else{
    message.channel.send(new Discord.MessageEmbed()
    .setColor(client.config.embedColors.music)
